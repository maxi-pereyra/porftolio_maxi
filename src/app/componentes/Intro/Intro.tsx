    ...
    <section id='home' className='scroll-mt-28 flex mt-6 mb-6 sm:mb-0'>
        <div className='flex flex-col  sm:ml-3 '>
            ...
            animate={{opacity: 1 , y: 0 }}>
                    ...
                    <span className='font-bold text-7xl flex items-start justify-start max-sm:text-4xl'>Maximiliano Pereyra.</span><br />
                    <span className='font-bold italic underline flex items-start justify-start  '>desarrollador web.</span><br />
                    <span className='text-base flex  w-1/2'>Soy programador full-stack, estudiante de desarrollo de software, entusiasta de las actividades al aire libre y me centro en resolver necesidades en base a codigo funcional.</span><br />
